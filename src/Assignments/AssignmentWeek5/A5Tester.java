...
public class A5Tester {
	...
	public static void testCountSongs() {
		...
		// Additional tests:
        LinkedSongList list4 = new LinkedSongList(); // Empty list
        LinkedSongList list5 = new LinkedSongList(); // Single song with duration 0
        LinkedSongList list6 = new LinkedSongList(); // Multiple songs by same artist

        Song s13 = new Song("Empty Song", "Unknown", 0);
        list5.addFront(s13);

        Song[] songs6 = {s1, s3, s4, s9, s10}; // Taylor Swift songs only
        list6.buildFromArray(songs6);

        result = list4.countSongs();
        expected = 0;
        displayResults(result == expected, "countSongs in list4 (empty)");

        result = list5.countSongs();
        expected = 1;
        displayResults(result == expected, "countSongs in list5 (single song with duration 0)");

        result = list6.countSongs();
        expected = 5;
        displayResults(result == expected, "countSongs in list6 (multiple songs by same artist)");
	...
	public static void testTotalDuration() {
        ...
        expected = 0;
        displayResults(result == expected, "totalDuration in list4 (empty)");

        result = list5.totalDuration();
        expected = 0;
        displayResults(result == expected, "totalDuration in list5 (single song with duration 0)");

        result = list6.totalDuration();
        expected = 1207;
        displayResults(result == expected, "totalDuration in list6 (multiple songs by same artist)");
	...
	public static void testCountSongsByArtist() {
		...
		// Additional tests:
        LinkedSongList list4 = new LinkedSongList(); // Empty list
        LinkedSongList list5 = new LinkedSongList(); // Single song with artist "Unknown"
        LinkedSongList list6 = new LinkedSongList(); // Multiple songs by same artist
        ...
        result = list4.countSongsByArtist("Taylor Swift");
        expected = 0;
        displayResults(result == expected, "countSongsByArtist in list4 (empty)");

        result = list5.countSongsByArtist("Unknown");
        expected = 1;
        displayResults(result == expected, "countSongsByArtist in list5 (single song with artist 'Unknown')");

        result = list6.countSongsByArtist("Taylor Swift");
        expected = 5;
        displayResults(result == expected, "countSongsByArtist in list6 (multiple songs by same artist)");
	...
	public static void testContainsArtist() {
        ...
        result = list4.containsArtist("Taylor Swift");
        displayResults(!result, "containsArtist in list4 (empty list)");

        result = list5.containsArtist("Unknown");
        displayResults(result, "containsArtist in list5 (single song with artist 'Unknown')");

        result = list6.containsArtist("Taylor Swift");
        displayResults(result, "containsArtist in list6 (multiple songs by same artist)");
	...
	public static void testLongestSong() {
		...
		LinkedSongList list4 = new LinkedSongList(); // Empty list
        LinkedSongList list5 = new LinkedSongList(); // Single song with duration 0
        LinkedSongList list6 = new LinkedSongList(); // Multiple songs with same duration
        ...
        displayResults(result == null, "longestSong in list4 (empty)");

        result = list5.longestSong();
        displayResults(result == null, "longestSong in list5 (single song with duration 0)");

        result = list6.longestSong();
        displayResults(result.equals(s9), "longestSong in list6 (multiple songs with same duration)");
	...
	public static void testCountMostOddInARow() {
		...
		Integer[] arr5 = {3,3,3,3,3,3,3,3,3};
		...
		expected = 9;
		displayResults(result==expected, "countMostOddInARow in list with 9 n a row");
	...
	public static void testCountBetweenX() {
		...
		expected = 4;
		displayResults(result==expected, "count between 3s in {1, 2, 3, 4, 2, 5, 2, 5}");
		
		result = A5Exercises.countBetweenX(list5, 5);
		expected = 4;
		displayResults(result==expected, "count between 3s in {5, 2, 3, 4, 2, 5, 2, 3}");
