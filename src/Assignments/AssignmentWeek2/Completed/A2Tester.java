...
public class A2Tester {
	...
	public static void testMoneyRaised() {
		...
		expected = 259;
		displayResults(result==expected, "money raised with 3 items");
		
		result = f4.moneyRaised();
		expected = 255;
		displayResults(result==expected, "money raised with 2 items");
	...
	public static void testMoneySpent() {
		...
		bidderName = new String("Ali");
		result = f4.moneySpent(bidderName);
		expected = 255;
		displayResults(result==expected, "amount "+bidderName+" spent at f4");
	...
	public static void testMostExpensive() {
		...
		AuctionItem[] arr4 = {a2, a1, a3};
		AuctionItem[] arr5 = {a2, a1, a3, a4, a5};
		AuctionItem[] arr6 = {a2, a1, a6, a7};

		Fundraiser f1 = new Fundraiser("Family Fundraiser", arr1);
		Fundraiser f2 = new Fundraiser("Fall Fundraiser", arr2);
		Fundraiser f3 = new Fundraiser("Team Fundraiser", arr3);
		Fundraiser f4 = new Fundraiser("Team Fundraiser", arr4);
		Fundraiser f5 = new Fundraiser("Team Fundraiser", arr5);
		Fundraiser f6 = new Fundraiser("Team Fundraiser", arr6);
	...
	public static void testTotalMoneyRaised() {
		...
		AuctionItem[] arr4 = {a2, a3, a8, a9, a10, a1};
		AuctionItem[] arr5 = {a1, a2, a3, a4, a5, a6, a7, a8, a9, a10};
		...
		Fundraiser[] fundraisers3 = {f3, f0a, f2, f0b, f1};
		Fundraiser[] fundraisers4 = {f3, f0a, f2, f0b, f1, f4, f5};
	...
	public static void testMostExpensiveItems() {
		...
		AuctionItem[] arr0 = {a1, a2, a3, a4, a5, a6};
		AuctionItem[] arr1 = {a1};
		AuctionItem[] arr2 = {a2, a3, a4, a5};
		AuctionItem[] arr3 = {a6, a7, a8, a9, a10};		
		...
		Fundraiser f2 = new Fundraiser("Fall Fundraiser", arr2);
		Fundraiser f3 = new Fundraiser("Team Fundraiser", arr3);
		Fundraiser f4 = new Fundraiser("Team Fundraiser", arr0);
		
		Fundraiser[] fundraisers0 = {};
		Fundraiser[] fundraisers1 = {f1, f2};
		Fundraiser[] fundraisers2 = {f3, f2, f1};
		Fundraiser[] fundraisers3 = {f3, f2, f1, f4};
		...
		AuctionItem[] expected3 = {a8, a3, a1, a3};
		displayResults(equal(result, expected3), "most expensive items in fundraisers2");
	...
	public static void testAverageOfMostExpensive() {
		...
		// add more tests here
		result = A2Exercises.averageOfMostExpensive(fundraisers3);
		expected = 198.5;
		displayResults(Math.abs(result-expected)<THRESHOLD, "average of expensive items in fundraisers1");
